...
<button type="button" class="btn btn-default btn-round mb-2 ml-2 mr-1">Exptected Fee this Term : <span class="text-info"><b>UGX<?php echo number_format(expectedSchoolFeeOfAllStudents(),2);?></b></span></button>
</div>
...
<div class="col-8">
<h4 class="text-white">UGX<?php echo number_format(totalPaymentToday(),2);?></h4>
...
<div class="row align-items-end">
<div class="col-8">
<h4 class="text-white">UGX<?php echo number_format(totalMoneyReceived(),2);?></h4>
...
<div class="row align-items-end">
<div class="col-8">
<h4 class="text-white">UGX<?php echo number_format(totalOutstandingBill(),2); ?></h4>
...
<div class="row align-items-end">
<div class="col-8">
<h4 class="text-white">UGX<?php echo number_format(totalMoneyReceivedYearly(),2);?></h4>
...
if ($sql->rowCount()>0) {
    ...
    <td class="text-success">UGX <?php echo number_format($dataRow->amount_paid,2);?></td>
    <td class="text-danger">UGX <?php echo number_format($dataRow->rem_bal,2);?></td>
</tr>
    <?php 
